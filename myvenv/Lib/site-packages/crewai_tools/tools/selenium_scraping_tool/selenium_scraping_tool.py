...
# class SeleniumScrapingToolSchema(FixedSeleniumScrapingToolSchema):
#     """Input for SeleniumScrapingTool."""
#     website_urls: List[str] = Field(..., description="List of website urls to read the file")
#     css_element: str = Field(..., description="Mandatory css reference for element to scrape from the website")

# class SeleniumScrapingTool(BaseTool):
#     name: str = "Read website contents"
#     description: str = "A tool that can be used to read contents from multiple websites."
#     args_schema: Type[BaseModel] = SeleniumScrapingToolSchema
...
#     def __init__(self, website_urls: Optional[List[str]] = None, cookie: Optional[dict] = None, css_element: Optional[str] = None, **kwargs):
#         super().__init__(**kwargs)
#         if cookie is not None:
#             self.cookie = cookie
...
#             self.description = f"A tool that can be used to read contents from {len(website_urls)} websites."
#             self.args_schema = FixedSeleniumScrapingToolSchema
...
#         **kwargs: Any,
#     ) -> Any:
#         website_urls = kwargs.get('website_urls', self.website_urls)
#         css_element = kwargs.get('css_element', self.css_element)
#         all_content = []

#         for url in website_urls:
#             driver = self._create_driver(url, self.cookie, self.wait_time)
#             driver.get(url)
